...
The current release is compatible with current ITGmania versions **0.8.0** or newer.
...
I only added Jacket and side stats (useful only when there's 2 players since it gets hidden if there's 2 player originally)

![img](https://i.imgur.com/CSH0zRf.png)
